...
import io.coriolis.api.health.AwsDynamoDBHealthCheck;
...
public class ApiApplication extends Application<ApiConfiguration> {
    ...
    public void run(ApiConfiguration conf, Environment env) throws InterruptedException {
        ...
        Universe universe = new Universe(managedDynamoDBClient, metricRegistry);
        EDDNManager eddnManager = new EDDNManager(conf.getEddnHost(), conf.getEddnPort(), universe, metricRegistry);
        RefreshEDDBSystemsTask refresSystemsTask = new RefreshEDDBSystemsTask(conf.getEddbSystemJSONUrl(), universe, httpClient, managedDynamoDBClient.getClient());
        RefreshEDDBStationsTask refreshStationsTask = new RefreshEDDBStationsTask(conf.getEddbStationJSONUrl(), universe, httpClient, managedDynamoDBClient.getClient());
